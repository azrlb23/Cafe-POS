...
<template>
            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10 animate-fade-in-up">
                ...
                <router-link
                    ...
                    class="inline-flex items-center justify-center gap-2 bg-gradient-to-r from-amber-700 to-amber-800 hover:from-amber-800 hover:to-amber-900 text-white px-8 py-4 rounded-2xl font-black transition-all duration-300 shadow-lg shadow-amber-700/20 text-xs uppercase tracking-[0.15em] hover:scale-105 active:scale-95 text-center cursor-pointer"
                >
