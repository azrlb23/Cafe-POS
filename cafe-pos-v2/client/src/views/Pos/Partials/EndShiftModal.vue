            ...
            <div class="p-8">
                ...
                <div class="bg-slate-50 rounded-2xl p-4 mb-6 space-y-3 border border-slate-100">
                    ...
                    <div class="flex justify-between text-xs">
                        ...
                        <span class="font-bold text-slate-700 font-jakarta">Rp {{ Number(activeShift?.totalCashSales || 0).toLocaleString('id-ID') }}</span>
                    </div>
                    <div class="flex justify-between text-xs">
                ...
                <form @submit.prevent="submit" class="space-y-6">
                    ...
                    <div class="flex gap-4">
                        ...
                        <button type="submit" :disabled="processing" class="flex-1 h-14 rounded-2xl bg-red-500 hover:bg-red-600 text-white font-black transition-all shadow-lg shadow-red-500/20 disabled:opacity-50 cursor-pointer">
