...
<template>
    ...
    <AuthenticatedLayout>
        <div class="max-w-[1400px] mx-auto py-12 px-4 sm:px-6 lg:px-8 animate-fade-in-up">
            ...
            <!-- Flash Messages -->
            <div v-if="$page.props.flash.success" class="mb-8 bg-white border-l-4 border-amber-700 text-slate-900 px-6 py-4 rounded-xl flex items-center justify-between shadow-sm border border-slate-200">
